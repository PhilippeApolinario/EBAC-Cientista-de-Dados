...
def main():
    st.set_page_config(page_title = 'Telemarketing analisys',         page_icon = './img/telmarketing_icon.png',
        layout="wide",
        initial_sidebar_state='expanded'
    )
    st.write('# Telemarketing analisys')
    st.markdown("Utilizando a função file_uploader() para efetuar o upload de arquivos em .csv ou .xlsx")
    st.markdown("---")
...
# def page2():
#     st.markdown("# Download de arquivo")
#     # st.sidebar.markdown("# Download de arquivo")
